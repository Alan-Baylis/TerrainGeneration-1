...
public class SurfaceCreator : MonoBehaviour
{
    ...
    public void setOffsset(int x, int y, int z) {
    ...
    public void Refresh()
    {
        ...
        NoiseMethod method = Noise.noiseMethods[(int)type][dimensions - 1]; // WTF!!!
    ...
    void OnGUI() {
        if (GUI.Button(new Rect(110, 10, 100, 50), "Generate")) {
            setOffsset(Random.Range(1, 100), Random.Range(1, 100), Random.Range(1, 100));
            strength = Random.Range(0.5f, 1f);
            octaves = Random.Range(2, 8);
            lacunarity = Random.Range(1.3f, 3f);
            persistence = Random.Range(0f, 0.5f);
            rotation = new Vector3(Random.Range(1, 100), Random.Range(1, 100), Random.Range(1, 100));
            Refresh();
        }
    }
